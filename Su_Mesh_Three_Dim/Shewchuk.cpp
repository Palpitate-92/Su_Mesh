...
int _SHEWCHUK::grow_expansion(int elen, REAL *e, REAL b, REAL *h)
{
  REAL Q;
  INEXACT REAL Qnew;
  int eindex;
...
int _SHEWCHUK::grow_expansion_zeroelim(int elen, REAL *e, REAL b, REAL *h)
{
  REAL Q, hh;
  INEXACT REAL Qnew;
  int eindex, hindex;
...
int _SHEWCHUK::expansion_sum(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q;
  INEXACT REAL Qnew;
...
int _SHEWCHUK::expansion_sum_zeroelim1(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q;
  INEXACT REAL Qnew;
...
int _SHEWCHUK::expansion_sum_zeroelim2(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q, hh;
  INEXACT REAL Qnew;
...
int _SHEWCHUK::fast_expansion_sum(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q;
  INEXACT REAL Qnew;
  INEXACT REAL bvirt;
...
int _SHEWCHUK::fast_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q;
  INEXACT REAL Qnew;
  INEXACT REAL hh;
...
int _SHEWCHUK::linear_expansion_sum(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q, q;
  INEXACT REAL Qnew;
  INEXACT REAL R;
...
int _SHEWCHUK::linear_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q, q, hh;
  INEXACT REAL Qnew;
  INEXACT REAL R;
...
int _SHEWCHUK::scale_expansion(int elen, REAL *e, REAL b, REAL *h)
{
  INEXACT REAL Q;
  INEXACT REAL sum;
...
int _SHEWCHUK::scale_expansion_zeroelim(int elen, REAL *e, REAL b, REAL *h)
{
  INEXACT REAL Q, sum;
  REAL hh;
  INEXACT REAL product1;
...
int _SHEWCHUK::compress(int elen, REAL *e, REAL *h)
{
  REAL Q, q;
  INEXACT REAL Qnew;
  int eindex, hindex;
...
REAL _SHEWCHUK::estimate(int elen, REAL *e)
{
  REAL Q;
  int eindex;
...
REAL _SHEWCHUK::orient2dadapt(REAL *pa, REAL *pb, REAL *pc, REAL detsum)
{
...
REAL _SHEWCHUK::orient2d(REAL *pa, REAL *pb, REAL *pc)
{
...
REAL _SHEWCHUK::orient3dadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL permanent)
{
  // std::cout << "use orient3dadapt, plz check program!\n";
...
REAL _SHEWCHUK::orient3d(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
REAL _SHEWCHUK::incircleadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL permanent)
{
...
REAL _SHEWCHUK::incircle(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
REAL _SHEWCHUK::insphereexact(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
...
REAL _SHEWCHUK::insphereadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe, REAL permanent)
{
...
REAL _SHEWCHUK::insphere(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
